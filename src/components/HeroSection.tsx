  ...
  return (
    <section className="bg-gradient-to-b from-emerald-600 to-emerald-800 text-white py-20">
      <div className="container mx-auto px-4 text-center">
        <h1 className="text-4xl md:text-5xl font-bold mb-6">Una - Educação Ambiental e Educação Integrada</h1>
        <p className="text-xl mb-8 max-w-2xl mx-auto">Transforme sua comunidade através da educação ambiental e práticas sustentáveis</p>
